...
<html>
<head>
<title>Non Vacation Leave</title>
<style>
p{
font-size:20px;
}
...
<h1><u>APPLICATION FOR GRANT OF NON VACATION LEAVE</u></h1>
<p>
<b>From:</b><br>
...
<p>
Sir,<br>
Kindly grant me Non Vacation Leave on  <input type="text" id="days" name="days" placeholder="Enter no.of days..." required>  day(s) from  <input type="date" name="fromdate" required>  to  <input type="date" name="todate" required>  for the purpose of <input type="text" id="purpose" name="purpose" placeholder="Purpose of leave" required>.
</p>
<br><br>
