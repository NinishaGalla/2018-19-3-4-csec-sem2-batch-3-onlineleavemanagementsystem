...
input{width:15%;margin-bottom:20px;}
...
<h1><u>LEAVE APPLICATION FOR GRANT OF PERMISSION TO ATTEND SEMINAR/CONFERENCE/WORKSHOP/EXAMINATION/SPOT VALUATION etc.</u></h1>
<p>
<b>From:</b><br>
Name:<br>
Designation:<br>
...
<p>
Sir,<br>
Kindly grant me Permission to attend the <select>
  <option value="Seminar">Seminar</option>
  <option value="Conference">Conference</option>
  <option value="Workshop">Workshop</option>
  <option value="Examination">Examination</option>
  <option value="Spot Valuation">Spot Valuation</option>
</select> on  <input type="text" id="topic" name="topic" placeholder="Enter topic..." required> held at <input type="text" id="place" name="place" placeholder="Enter place..." required> for <input type="text" id="days" name="days" placeholder="Enter no.of days..." required> from  <input type="date" name="fromdate" required>  to  <input type="date" name="todate" required>. During my absence,my classwork will be taken up as detailed below:
</p>
...
<button type="submit">Apply Leave</button></form>
</body>
</html>
