...
if(isset($_REQUEST['approve'])){
  ...
  $q="update cancelleave set status='$status' where id='$id' and applydate='$applydate' and name='$name' and purpose='$purpose'";
...
$sql="SELECT * FROM cancelleave where department='$dept'";
