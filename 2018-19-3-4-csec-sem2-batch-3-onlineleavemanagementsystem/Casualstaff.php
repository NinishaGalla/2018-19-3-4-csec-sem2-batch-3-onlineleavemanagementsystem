...
<p>
Sir,<br>
Kindly grant me CL for  <input type="text" name="days" placeholder="Enter number of days...">  day(s) from  <input type="date" name="fromdate" required>  to  <input type="date" name="todate" required>  for the purpose of <input type="text" id="purpose" name="purpose" placeholder="Purpose of leave" required>.
</p>
